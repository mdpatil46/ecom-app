  ...
  return (
    <>
      <div className="flex flex-row space-x-80 ">
        <div className="">
          {heding && (
            <div className="flex  items-center justify-center mt-12 sm:ml-2 sm:mr-2 overflow-hidden">
            ...
            <div className="flex  items-center justify-center mt-8 overflow-hidden">
              <div className="relative flex w-full max-w-[48rem] flex-row rounded-xl bg-gray-100 bg-clip-border text-gray-700 shadow-md">
                ...
                <div className="p-6">
                  ...
                  <button
                    className="m-2"
                    onClick={() => setShowdiv(false, setHeding(true))}
                  >
        ...
        >
          {showdiv && (
            <>
              ...
              <div className="mt-1">
                <p className="text-xl font-semibold">{amountIn}</p>
              </div>
              <div className="mt-1">
                <p className="font-normal text-xs text-green-700">In stock</p>
                <p className=" block font-sans text-base font-semibold leading-relaxed text-gray-700 antialiased">
                  Eligible for FREE Shipping
                </p>
                <p className=" block font-sans text-base font-semibold leading-relaxed text-black antialiased">
                  Colour:Titanium
                </p>
                <p className=" block font-sans text-base font-semibold leading-relaxed text-black antialiased">
                  Size: 256 GB
