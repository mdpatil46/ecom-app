      ...
      <div className="bg-gray-100 h-14 text-black flex items-center w-full sm:h-20">
        <div className="mx-2 sm:mx-80 text-center">
          <p className="text-xs sm:text-base">
            Save up to ₹6000.00 instantly on selected iPhone models with HDFC
            Bank Credit Cards.+ Plus No Cost EMI from most leading banks.
          </p>
        </div>
      </div>
      ...
      <div className=" mx-auto flex-wrap justify-center  bg-gray-200 mt-0 overflow-hidden">
        <div className="bg-black flex justify-center items-center">
          <div className="flex flex-col items-center justify-center">
            ...
            <img
              src="https://www.apple.com/v/iphone/home/br/images/overview/hero/iphone_15_pro_logo__xsnr3zpj28yu_large.jpg"
              alt=""
              className="mt-5"
            />
            <img
              src="https://www.apple.com/v/iphone/home/br/images/overview/hero/headline_titanium__cj5ay941qj6u_large.jpg"
              alt=""
              className="mt-6"
            />
            ...
            <img
              src="https://www.apple.com/v/iphone/home/br/images/overview/hero/hero_iphone_15_pro__eqwrvy72748y_large.jpg"
              alt=""
              className="mt-8 ml-44 mb-24"
            />
          </div>
        </div>
