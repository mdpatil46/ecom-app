...
function changeNav(isLogoClick){
  ...
  return (
    <>
      <nav className="bg-gray-300 text-black opacity-80 p-2 flex flex-wrap justify-between items-center sm:px-6 lg:px-8*" id='changeNavbar'>
      ...
      <Link to ="/Addcart" className='md:flex hidden hover:text-2xl font-bold'>Cart</Link>
      </nav>
    </>
  )
}
